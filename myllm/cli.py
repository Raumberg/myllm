...
def train(
    ...
    # Check if we need to resize model embeddings after tokenizer setup
    if hasattr(dm.tokenizer_wrapper, 'vocab_size_changed') and dm.tokenizer_wrapper.vocab_size_changed:
        logger.info("Resizing model embeddings due to added tokens")
